...
public class MainActivity extends AppCompatActivity {
    ...
    String mainURL = "https://lenadashboard.dynv6.net:2525/d/adfckvk/domoticz?orgId=1&from=now-30m&to=now&timezone=browser&refresh=1m&kiosk=true&disable_timepicker=true";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            registerReceiver(unifiedPushEndpointReceiver, new IntentFilter("com.domoticz.webtoapk.NEW_ENDPOINT"), RECEIVER_NOT_EXPORTED);
        } else {
            registerReceiver(unifiedPushEndpointReceiver, new IntentFilter("com.domoticz.webtoapk.NEW_ENDPOINT"));
        }
